...
public partial class PlaylistClient
{
    public Playlist Get(
        ...
        var response = _controller.GetPlaylistResponse(playlistId, cancellationToken);
    ...
    public PlaylistVideo[] GetVideos(
        PlaylistId playlistId,
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        var encounteredIds = new HashSet<VideoId>();
        ...
        do
        {
            var response = _controller.GetPlaylistNextResponse(
                playlistId,
                lastVideoId,
                lastVideoIndex,
                visitorData,
